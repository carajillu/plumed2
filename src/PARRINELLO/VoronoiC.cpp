...
public:
  explicit VoronoiC(const ActionOptions&);
  ~VoronoiC();
// active methods:
...
PLUMED_REGISTER_ACTION(VoronoiC,"VORONOIC")

void VoronoiC::registerKeywords( Keywords& keys ) {
...
VoronoiC::VoronoiC(const ActionOptions&ao):
